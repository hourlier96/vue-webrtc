...
// module
exports.push([module.i, ".video-list[data-v-31657b7a]{background:#000;height:auto;height:100%;width:100%}.video-item[data-v-31657b7a]:first-child:last-child,video[data-v-31657b7a]{width:100%;height:100%}.video-item:first-child:nth-last-child(2)~.video-item[data-v-31657b7a],.video-item[data-v-31657b7a]:first-child:nth-last-child(2){width:100%;height:50%}.video-item:first-child:nth-last-child(3)~.video-item[data-v-31657b7a],.video-item:first-child:nth-last-child(4)~.video-item[data-v-31657b7a],.video-item[data-v-31657b7a]:first-child:nth-last-child(3),.video-item[data-v-31657b7a]:first-child:nth-last-child(4){width:50%;height:50%}.video-item:first-child:nth-last-child(5)~.video-item[data-v-31657b7a],.video-item:first-child:nth-last-child(6)~.video-item[data-v-31657b7a],.video-item[data-v-31657b7a]:first-child:nth-last-child(5),.video-item[data-v-31657b7a]:first-child:nth-last-child(6){width:50%;height:33.3%}.video-item:first-child:nth-last-child(n+7)~.video-item[data-v-31657b7a],.video-item[data-v-31657b7a]:first-child:nth-last-child(n+7){width:33%;height:33.3%}.video-item:first-child:nth-last-child(n+10)~.video-item[data-v-31657b7a],.video-item[data-v-31657b7a]:first-child:nth-last-child(n+10){width:25%;height:33.3%}.video-item:first-child:nth-last-child(n+12)~.video-item[data-v-31657b7a],.video-item[data-v-31657b7a]:first-child:nth-last-child(n+12){width:25%;height:25%}.video-item:first-child:nth-last-child(n+17)~.video-item[data-v-31657b7a],.video-item[data-v-31657b7a]:first-child:nth-last-child(n+17){width:20%;height:20%}.video-item:first-child:nth-last-child(n+26)~.video-item[data-v-31657b7a],.video-item[data-v-31657b7a]:first-child:nth-last-child(n+26){width:16.6%;height:20%}.video-item:first-child:nth-last-child(n+31)~.video-item[data-v-31657b7a],.video-item[data-v-31657b7a]:first-child:nth-last-child(n+31){width:16.6%;height:16.6%}video[data-v-31657b7a]::-webkit-media-controls{display:none!important}.video-item[data-v-31657b7a]{background:#000;display:inline-block;cursor:pointer;position:relative}.video-item .overlay[data-v-31657b7a]{position:absolute;top:15px;left:10px;width:100%;z-index:-1}.video-item .overlay h3[data-v-31657b7a]{font-size:160%;color:#fff;font-weight:700}.video-item[data-v-31657b7a]:hover{border:3px solid;border-color:red}.video-item:hover>.overlay[data-v-31657b7a]{z-index:2}", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('div', {
      ...
      staticClass: "overlay"
    }, [_c('h3', [_vm._v(_vm._s(_vm.displayedName))])])])
  }), 0)
},staticRenderFns: []}
